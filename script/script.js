function setUpEvents(){
 ...
 // const contactNames = document.querySelectorAll('.contactName');
  ...
  //const faSearch = document.getElementById("fa-search");
    ...
    var newDiv = function createDivElements(){  
      for (var i = 0; i < contacts.length; i++) {
        var el = document.createElement("div");
        //console.log(el);
        el.innerHTML = contacts[i].name;
        //console.log(el.innerHTML);
        el.className = 'contactName'; // add an class attribute
        el.id = i; // add an id of i
        contactList.appendChild(el); // append the new div to the contact-list 
        }
      }
